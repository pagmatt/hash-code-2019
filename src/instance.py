...
class SubInstance ():
    def __init__(self, filesList: "list[CompiledFile]", filesDict: "dict[str, CompiledFile]", target: list, nservers):
    ...
    def getTimesAndIdx(self, fname: str):
